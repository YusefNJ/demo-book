...
public class Book {
	...
	public Book(int id, String name, Author[] authors, Publisher publisher, BigDecimal price, CoverType coverType) {
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "Book [id= " + id + ", name= " + name + ", authors= " + authors + ", publisher= " + publisher +
